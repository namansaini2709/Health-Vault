  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-gray-800 dark:via-gray-900 dark:to-gray-900 dark:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6 dark:text-white">
              Your Health Data is
              <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent block dark:from-green-400 dark:to-emerald-400">
                Protected by Design
              </span>
            </h1>
      ...
      <section className="py-12 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center dark:text-white">Core Security Features</h2>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center dark:text-white">How Your Data is Protected</h2>
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center dark:text-white">Additional Security Measures</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 text-sm dark:text-gray-300">AWS cloud infrastructure with redundancy and automatic failover</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 text-sm dark:text-gray-300">All database connections encrypted with TLS/SSL protocols</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 text-sm dark:text-gray-300">Third-party security audits and penetration testing</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600 text-sm dark:text-gray-300">24/7 monitoring with immediate breach notification protocols</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Shield className="h-16 w-16 text-green-600 mx-auto mb-6 dark:text-green-400" />
            <h2 className="text-3xl font-bold text-gray-900 mb-4 dark:text-white">Our Privacy Guarantee</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
                <EyeOff className="h-8 w-8 text-green-600 mb-3 dark:text-green-400" />
                <h3 className="font-semibold mb-2 dark:text-white">We Can't See Your Files</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">Files are encrypted before leaving your device</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
                <UserCheck className="h-8 w-8 text-green-600 mb-3 dark:text-green-400" />
                <h3 className="font-semibold mb-2 dark:text-white">You Control Access</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">Grant and revoke permissions at will</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
                <Lock className="h-8 w-8 text-green-600 mb-3 dark:text-green-400" />
                <h3 className="font-semibold mb-2 dark:text-white">No Data Selling</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">We never sell or share your health data</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button size="lg" className="bg-white text-green-600 hover:bg-gray-100 dark:bg-gray-800 dark:text-green-300 dark:hover:bg-gray-700" onClick={() => navigate('/patient-register')}>
